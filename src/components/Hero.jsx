...
const Hero = () => {
  ...
  return (
    <div className="relative w-full h-full flex justify-end bg-gradient-to-t from-black via-transparent to-black overflow-hidden">
      ...
      {/* :HERO IMAGE */}
      <img src={image1} alt="" className="absolute w-full h-full object-cover object-left sm:object-center opacity-70" />
      ...
      <div className="relative py-28 xl:py-40 w-full md:w-2/3 lg:w-1/2 h-full flex flex-col justify-center">
        ...
        <div className="mx-5 md:mx-0 p-8 rounded-xl md:rounded-r-none bg-gray-800 bg-opacity-50 text-white shadow-2xl">
          <h1 className="text-3xl sm:text-5xl font-josefin font-extrabold">Welcome to the <br/><span className="text-yellow-400 text-opacity-80">ICT SOCIETY</span>  <br/></h1>
          <p className="mt-3 text-gray-100 font-firacode">Join us in providing quality solutions and innovations in the University and the country as a whole.</p>
        </div>
